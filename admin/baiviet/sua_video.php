    ...
    if(isset($_REQUEST['ma_bai_viet']))
    {
        ...
        if($_SERVER['REQUEST_METHOD']=='POST') //Nhan nut submit
        {
            ...
            if(empty($error)){
                ...
                if($video!='')
                {
                $query = "update bai_viet set trang_thai='$trt', tieu_de='$ten_file', link='$video', ma_danh_muc='$danh_muc', ma_user='$ma_user' where ma_bai_viet=$mabv";
                }
                else
                {
                $query = "update bai_viet set trang_thai='$trt', tieu_de='$ten_file', ma_danh_muc='$danh_muc', ma_user='$ma_user' where ma_bai_viet=$mabv";
                }
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Sửa video</div>
...
<div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        if($r[4]==1)
                        {
                            echo "<iframe width='320' height='240' src='$r[6]' frameborder='0' allowfullscreen>";
                            echo "</iframe>";
                        }
                        ?>
                        <input type="text" name="fVideo" class="form-control" value="<?php if(isset($r) && $r[4]==1) echo $r[6]; ?>"/>                   
                            <?php
