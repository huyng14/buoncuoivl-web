...
<?php if($baiviet[$i]->trang_thai==1) { ?>
<article>  
    <a href="index.php?page=detail&ma_bai_viet=<?php echo $baiviet[$i]->ma_bai_viet; ?>"><h2><?php echo $baiviet[$i]->tieu_de; ?></h2></a>
            <?php           
    ...
    <a href="index.php?page=detail&ma_bai_viet=<?php echo $baiviet[$i]->ma_bai_viet; ?>"><p><img src='<?php echo $linkAnh; ?>' width='100%' height='100%'><p></a>
            ...
            ?>
            <a name="<?php echo $baiviet[$i]->ma_bai_viet; ?>">
